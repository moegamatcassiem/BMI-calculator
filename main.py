...
header = Label(root, text='Body Mass Index', bg='orange', fg='black')
header.place(x=220, y=20)

frame = Frame(root, width=500, height=200, relief='raised', bg='orange')
frame.place(relx=0.15, rely=0.1)

weight = Label(frame, text="Weight(kg):", bg='orange', fg='black')
weight.place(relx=0.1, rely=0.1)
weight_entry = Entry(frame)
weight_entry.place(relx=0.4, rely=0.1)

height = Label(frame, text="Height(cm):", bg='orange', fg='black')
height.place(relx=0.1, rely=0.3)
height_entry = Entry(frame)
height_entry.place(relx=0.4, rely=0.3)

gender = Label(frame, text="Gender:", bg='orange', fg='black')
gender.place(rely=0.53, relx=0.1)

age = Label(frame, text="Age:", bg='orange', fg='black')
...
# Calculates BMI with information entered
...
category_head = Label(root, text="Category:", bg='orange', fg='black')
category = Label(root, width=20, bg='orange', fg='black')
